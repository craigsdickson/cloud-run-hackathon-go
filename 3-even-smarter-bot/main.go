...
func play(input ArenaUpdate) (response string) {
	...
	if isSomeoneInFrontOfMe(myState, board, 3) {
...
func moveTowardsNextClosestHighestRankedPlayer(myState PlayerState, board [][]bool) {
...
func isSomeoneInFrontOfMe(myState PlayerState, board [][]bool) (result bool) {
	myXcoord := myState.X
	myYcoord := myState.Y
