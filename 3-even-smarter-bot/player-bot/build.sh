...
gcloud builds submit --project microbot-hackathon --config ./3-even-smarter-bot/go/cloudbuild.yaml --substitutions=COMMIT_SHA=latest --ignore-file=$DIR/.gcloudignore .
